...
switch(completionLevel)
{
	...
	case 2:
		draw_sprite_ext(complete2, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);	
		//draw_sprite_ext(complete1, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);
	...
	case 3:
		draw_sprite_ext(complete3, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);	
		//draw_sprite_ext(complete1, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);
		//draw_sprite_ext(complete2, 0, x + x2, y + y2, .5, .5, image_angle, image_blend, image_alpha);
	...
	case 4:
		draw_sprite_ext(complete4, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);	
		//draw_sprite_ext(complete1, 0, x + x1, y + y1, .5, .5, image_angle, image_blend, image_alpha);
		//draw_sprite_ext(complete2, 0, x + x2, y + y2, .5, .5, image_angle, image_blend, image_alpha);
		//draw_sprite_ext(complete3, 0, x + x3, y + y3, .5, .5, image_angle, image_blend, image_alpha);
	break;	
